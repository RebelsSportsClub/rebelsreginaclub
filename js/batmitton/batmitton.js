...
function batmittonTab(){
	

	clearInterval(xc);
	
	 document.getElementById('latestResult-h4').innerHTML  = 'Rebels Winter League - Batmitton';
	 document.getElementById('latestResult-p').innerHTML  = 'Rebels Winter League Batmitton tournaments latest score';
	 
     document.getElementById('latestResult-badge1').style = 'background:url(images/team-logo/bat1.png)';
	 document.getElementById('latestResult-team1-name').innerHTML  = 'Player 1';
	 document.getElementById('latestResult-team1-result').innerHTML  = 'Lost';
	 document.getElementById('latestResult-team1-topScorer').innerHTML  = '15/8/9';
	 ...
	 document.getElementById('latestResult-badge2').style = 'background:url(images/team-logo/bat2.png)';
	 document.getElementById('latestResult-team2-name').innerHTML  = 'Player 2';
	 document.getElementById('latestResult-team2-result').innerHTML  = 'Win';
	 document.getElementById('latestResult-team2-topScorer').innerHTML  = '15/15/15';
	 
	 
	 document.getElementById('matchSchedule').innerHTML  = 'Rebels Batmitton has all around the year activities. Players participate in Rebels Batmitton League which takes place in Fall, Winter and Summer. Players play doubles and singles depending upon the number of registration during the season.';
	 
	 document.getElementById('nextMatch-p').innerHTML  = 'Upcomming match in the Rebels Batmitton League - Fall 2017';
	 
	 var logoimg1 = document.getElementById("nextMatch-logo1");
	 logoimg1.src="images/matchResult/bat2.png";
	 
	 var logoimg2 = document.getElementById("nextMatch-logo2");
	 logoimg2.src="images/matchResult/bat1.png";
	 
	 document.getElementById('nextMatch-dateTime').innerHTML  = 'October 31, 2017 | 7:00 PM';
	 document.getElementById('nextMatch-place').innerHTML  = 'Regina (Canada)';

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 
	// Set the date we're counting down to
	var countDownDate = new Date("Oct 31, 2017 15:00:00").getTime();
